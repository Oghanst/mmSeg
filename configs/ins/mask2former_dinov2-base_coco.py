...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ins/mask2former_dinov2-base_coco.py --work-dir work_dirs/dinov2 --cfg-options train_dataloader.batch_size=1 --amp